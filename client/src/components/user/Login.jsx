            ...
            <div className='parent-contain'>
                ...
                <div className='form-sign'>
                    ...
                    <p className='' style={{ color: '#878787' }}>
                        By continuing, you agree to Flipkarts <Link className='link-offset-2 link-underline link-underline-opacity-0'>Terms of Use</Link> and <a className='link-offset-2 link-underline link-underline-opacity-0' href="#">Privacy Policy</a>
                    </p>
                    <div className='d-grid gap-2'>
                        <button className='sign-button'><Link to="/otp">Request OTP</Link></button>
